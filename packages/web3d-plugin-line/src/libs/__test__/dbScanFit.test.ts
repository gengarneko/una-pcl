  ...
  it("should correctly identify clusters", () => {
    ...
    const positions = new Float32BufferAttribute(
      [
        ...
        5,
        5,
        5, // point 4 - this is further away and should be noise
      ],
      3,
    );
  ...
  it("should correctly identify clusters", () => {
    ...
    const positions = new Float32BufferAttribute(
      [
        ...
        5,
        5,
        5, // point 3 - this is further away and should be noise
      ],
      3,
    );
  ...
  it("should correctly identify three clusters from the given points", () => {
    ...
    const positions = new Float32BufferAttribute(
      [
        ...
        // Cluster 2
        10, 10, 10, 11, 11, 11, 10, 11, 10, 11, 10, 11,
        // Cluster 3
        20, 20, 20, 20, 21, 20, 21, 20, 20, 21, 21, 21,
        // More points in clusters to make up 20 points
        // Additional points for Cluster 1
        0.5, 0.2, 0.1, 0.9, 0.8, 1.0,
        // Additional points for Cluster 2
        10.2, 10.2, 10.1, 10.7, 10.9, 10.8,
        // Additional points for Cluster 3
        20.3, 20.1, 20.4, 20.6, 20.5, 20.5,
        // Noise points

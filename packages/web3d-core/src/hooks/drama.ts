...
export const setupDrama = (
  ...
  const {
    ...
    onSetup: onThreeViewSetup,
    onChange: onThreeViewChange,
    onConfirm: onThreeViewConfirm,
    confirmEvent: threeViewConfirmEventHook,
    changeEvent: threeViewChangeEventHook,
  } = useThreeView();
  ...
  return {
    normal: {
      ...
      mouseState,
      onAdvanceMouseEvent: mouseEventHook.on,
      frames,
      primaryFrame,
      activeFrames,
      selectFrame,
    ...
    advance: {
      ...
      onBeforeRender,
      renderBeforeHook,
      threeViewConfirmEventHook,
      threeViewChangeEventHook,
      onSetupAnswer,
      originAnswer: answer,
    } as const,
  } as const;

...
const _rectMaterial = /*@__PURE__*/ new THREE.MeshBasicMaterial({
  name: "box::surface",
  color: 0xff0000,
  opacity: 0.2,
  transparent: true,
});
const _rectFocusMaterial = /*@__PURE__*/ new THREE.MeshBasicMaterial({
  name: "box[focus::surface]",
  color: 0xff0000,
  opacity: 0.4,
  transparent: true,
});
const _edgeMaterial = /*@__PURE__*/ new THREE.LineBasicMaterial({
  name: "box::edge",
  color: 0xffffff,
});
const _edgeFocusMaterial = /*@__PURE__*/ new THREE.LineBasicMaterial({
  name: "box[focus]::edge",
  color: 0x007bff,

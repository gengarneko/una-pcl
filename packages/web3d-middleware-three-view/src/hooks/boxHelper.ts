    ...
    return [
      {
        ...
        point: o
          .clone()
          .sub(axis[axis2d[name].x])
          .add(axis[axis2d[name].y])
          .add(axis[axis2d[name].z]),
      },
      {
        pos: "n",
        point: o.clone().add(axis[axis2d[name].y]).add(axis[axis2d[name].z]),
      },
      {
        pos: "ne",
        point: o
          .clone()
          .add(axis[axis2d[name].x])
          .add(axis[axis2d[name].y])
          .add(axis[axis2d[name].z]),
      },
      {
        pos: "e",
        point: o.clone().add(axis[axis2d[name].x]).add(axis[axis2d[name].z]),
      },
      {
        pos: "se",
        point: o
          .clone()
          .add(axis[axis2d[name].x])
          .sub(axis[axis2d[name].y])
          .add(axis[axis2d[name].z]),
      },
      {
        pos: "s",
        point: o.clone().sub(axis[axis2d[name].y]).add(axis[axis2d[name].z]),
      },
      {
        pos: "sw",
        point: o
      ...
      {
        pos: "w",
        point: o.clone().sub(axis[axis2d[name].x]).add(axis[axis2d[name].z]),
      },
    ];
  };

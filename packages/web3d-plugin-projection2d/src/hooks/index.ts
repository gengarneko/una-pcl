...
import {
  FisheyeCoefficients,
  FisheyeDistortionShader as FisheyeDistortionShaderPreCalc,
  computeFisheyeLUT,
} from "../libs/FisheyeDistortionPreCalc";
...
export const useProjection2d = (
  ...
  composer.render = measure(
    "web3d::projection2d::render",
    composer.render.bind(composer),
  );
